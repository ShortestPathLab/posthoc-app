...
export function FeatureCard({
  ...
  return (
    <Box variant="filled" sx={{ ...paper(1), position: "relative", height: "100%" }} {...rest}>
      <>
        <CardHeader
          sx={{
    ...
    <TabContext value={tab}>
      <Page onChange={onChange} stack={state}>
        ...
        <Page.Content>
          <Block vertical>
            <Scroll y>
              <Box sx={narrow ? undefined : { p: 4, maxWidth: CONTENT_WIDTH, mx: "auto" }}>
                <Box sx={{ pt: 6 }}>
                  <TabPanel value="explore" sx={{ p: 0 }}>
                    <Box sx={{ p: 4, textAlign: "center" }}>
                      ...
                      <Type component="div" variant="subtitle2" color="textSecondary">
