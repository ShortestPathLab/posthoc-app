...
import { findLast, isArray, keys, map, startCase } from "es-toolkit/compat";
  ...
  return (
    <TabContext value={tab}>
      <Page onChange={onChange} stack={state}>
        ...
        <Page.Options>
          <TabList onChange={(_, v) => setTab(v)} sx={{ mx: 0, "& button": { minWidth: 0 } }}>
        ...
        <Page.Content>
          <Stack sx={{ pt: 6 }} ref={ref as Ref<HTMLDivElement>}>
            ...
            <TabPanel value="security" sx={{ p: 2 }}>
              ...
              <Box sx={{ maxWidth: 480 }}>
                <Typography component="div" color="textSecondary" variant="caption" sx={{ pt: 2 }}>
...
export function TrustedOriginListEditor() {
  ...
  const b = useMemo(() => map(trustedOrigins, (t) => ({ key: t })), [trustedOrigins]);
  return (
    // <List>
